...
{
    public partial class ViewDataForAdmin : Form
    {
        ...
        public void DisplayData()
        {
            ...
            string query = @"SELECT
                                ...
                                a.working_hours AS AdminWorkingHours,
                                a.employment_type AS AdminEmploymentType,
                                a.salary AS AdminSalary
                            FROM
                                users u
                            LEFT JOIN students s ON u.id = s.user_id
                            LEFT JOIN teachers t ON u.id = t.user_id
                            LEFT JOIN admins a ON u.id = a.user_id"; // SQL query to fetch data
        ...
        public void TextBoxFilter()
        {
            ...
            if (!string.IsNullOrEmpty(txtSearchBox.Text))
            {
                ...
                /*query += " AND (u.name LIKE '%" + txtSearchBox.Text + "%'" +
                         " OR t.salary = " + txtSearchBox.Text + ")";*/
            }
        ...
        {
            AdminMenu adminMenu = new AdminMenu(); // Create an instance of AdminMenu form
